...
export const RegisterIPAssetParametersSchema = createParameterSchema(
    z.object({
        ...
        externalUrl: z.string().url().optional().describe('An optional external URL for the IP asset'),
    })
);
...
export const RegisterDerivativeParametersSchema = createParameterSchema(
    z.object({
        ...
        contentHash: z.string().min(1).describe('The hash of the content'),
        externalUrl: z.string().url().optional().describe('An optional external URL for the derivative IP asset'),
